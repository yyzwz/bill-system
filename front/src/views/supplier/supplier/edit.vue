<template>
  <div>
    <Card>
      ...
      <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left" >        <FormItem label="供应商名称" prop="name"  >
          <Input v-model="form.name" clearable style="width:570px"/>
        </FormItem>
        <FormItem label="供应商电话" prop="mobile"  >
...
import { editSupplier } from "./api.js";
export default {
  name: "edit",
  components: {
    },
