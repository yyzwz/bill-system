    ...
    <Card>
      ...
      <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left" >        
        <Select v-model="form.supplierId" clearable style="width:570px">
            ...
            <!-- <Input v-model="form.supplierId" clearable style="width:570px"/> -->
          </FormItem>
          <FormItem label="商品" prop="commodityId"  >
            <Select v-model="form.commodityId" clearable style="width:570px">
              <Option
            ...
            <!-- <Input v-model="form.commodityId" clearable style="width:570px"/> -->
          </FormItem>
          <FormItem label="数量" >
...
import { editBill ,getAllSupplierList , getAllCommodityList  } from "./api.js";
export default {
  name: "edit",
  components: {
    },
