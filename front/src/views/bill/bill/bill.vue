        ...
        <Row v-show="openSearch" @keydown.enter.native="handleSearch">          
          <Form ref="searchForm" :model="searchForm" inline :label-width="70">
              ...
              <Form-item label="商品" prop="commodityId">
                <Select v-model="searchForm.commodityId" clearable style="width:200px">
                  <Option
                    v-for="(item, i) in this.commodityList"
                    :key="i"
                    :value="item.id"
                  >{{item.name}}</Option>
                </Select>
              ...
              <Form-item label="负责员工" prop="userId">
                <Input type="text" v-model="searchForm.userId" placeholder="请输入负责员工Id" clearable style="width: 200px"/>
              </Form-item>
...
import { getBillList, deleteBill ,getAllSupplierList , getAllCommodityList} from "./api.js";
// 根据你的实际添加编辑组件位置路径修改
