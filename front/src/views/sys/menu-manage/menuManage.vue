        ...
        <Row type="flex" justify="start">
            ...
            <Form ref="form" :model="form" :label-width="110" :rules="formValidate">
                ...
                <FormItem label="始终显示" prop="showAlways" v-if="form.level==1" class="block-tool">
                    ...
                    <Tooltip content="当设为不始终显示时，一级菜单下仅有一个子级菜单只会显示该子级菜单，避免用户多次点击" placement="right" transfer max-width="280" style="display: inline-block !important;">
...
import IconChoose from "@/views/my-components/zwz/icon-choose";
